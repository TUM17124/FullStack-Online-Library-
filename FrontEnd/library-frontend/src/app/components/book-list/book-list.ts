...
export class BookListComponent {
  ...
  borrowBook(id: number) {
    if (!this.authService.isLoggedIn()) {
      this.snackBar.open('You need to register or login to borrow books', 'Register', {
        duration: 6000,
  ...
  extractKey(book: any): string {
    ...
    const keywords = [
      'angular', 'react', 'vue', 'django', 'python', 'java',
      'javascript', 'typescript', 'node', 'spring', 'html', 'css',
      'flutter', 'dart', 'flask', 'machine learning', 'data science',
      ...
      'blockchain', 'cloud computing', 'devops', 'microservices',
      'kubernetes', 'docker'
    ];
